// Voco Chrome Extension — ChatGPT 日报自动同步
let SERVER_URL = 'https://voco.onrender.com';
...
function addSendButtons() {
  ...
  messages.forEach(msg => {
    ...
    btn.innerHTML = '📤 同步到 Voco';
    btn.title = '一键发送日报到 Voco';
...
async function sendToLingoTrace(msgElement) {
  ...
  try {
    ...
    showToast('❌ 无法连接到 Voco。请确保服务已启动。', 'error');
  }
}

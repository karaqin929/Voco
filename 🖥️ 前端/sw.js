...
const CACHE = 'voco-v127';
const FILES = ['/','/index.html?v=117','/style.css?v=117','/app.js?v=117','/manifest.json','/supabase-client.js?v=117','/parser.js?v=117','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

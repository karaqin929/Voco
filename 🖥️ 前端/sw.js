...
const CACHE = 'voco-v99';
const FILES = ['/','/index.html?v=89','/style.css?v=89','/app.js?v=89','/manifest.json','/supabase-client.js?v=89','/parser.js?v=89','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

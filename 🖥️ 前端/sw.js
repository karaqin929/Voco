...
const CACHE = 'voco-v23';
const FILES = ['/','/index.html?v=21','/style.css?v=21','/app.js?v=21','/manifest.json','/supabase-client.js?v=21','/parser.js?v=21','/icon.png','/bear-default.png','/bear-active.png'];

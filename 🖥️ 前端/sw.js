...
const CACHE = 'voco-v27';
const FILES = ['/','/index.html?v=25','/style.css?v=25','/app.js?v=25','/manifest.json','/supabase-client.js?v=25','/parser.js?v=25','/icon.png','/bear-default.png','/bear-active.png'];

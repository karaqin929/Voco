...
const CACHE = 'voco-v22';
const FILES = ['/','/index.html?v=20','/style.css?v=20','/app.js?v=20','/manifest.json','/supabase-client.js?v=20','/parser.js?v=20','/icon.png','/bear-default.png','/bear-active.png'];

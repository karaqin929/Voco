...
const CACHE = 'voco-v26';
const FILES = ['/','/index.html?v=24','/style.css?v=24','/app.js?v=24','/manifest.json','/supabase-client.js?v=24','/parser.js?v=24','/icon.png','/bear-default.png','/bear-active.png'];

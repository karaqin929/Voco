...
const CACHE = 'voco-v13';
const FILES = ['/','/index.html?v=11','/style.css?v=11','/app.js?v=11','/manifest.json','/supabase-client.js?v=11','/parser.js?v=11','/icon.png','/bear-default.png','/bear-active.png'];

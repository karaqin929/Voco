...
const CACHE = 'voco-v25';
const FILES = ['/','/index.html?v=23','/style.css?v=23','/app.js?v=23','/manifest.json','/supabase-client.js?v=23','/parser.js?v=23','/icon.png','/bear-default.png','/bear-active.png'];

...
const CACHE = 'voco-v19';
const FILES = ['/','/index.html?v=17','/style.css?v=17','/app.js?v=17','/manifest.json','/supabase-client.js?v=17','/parser.js?v=17','/icon.png','/bear-default.png','/bear-active.png'];

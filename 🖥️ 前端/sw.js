...
const CACHE = 'voco-v82';
const FILES = ['/','/index.html?v=72','/style.css?v=72','/app.js?v=72','/manifest.json','/supabase-client.js?v=72','/parser.js?v=72','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

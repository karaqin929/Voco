...
const CACHE = 'voco-v132';
const FILES = ['/','/index.html?v=122','/style.css?v=122','/app.js?v=122','/manifest.json','/supabase-client.js?v=122','/parser.js?v=122','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

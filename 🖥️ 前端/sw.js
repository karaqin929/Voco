...
const CACHE = 'voco-v28';
const FILES = ['/','/index.html?v=26','/style.css?v=26','/app.js?v=26','/manifest.json','/supabase-client.js?v=26','/parser.js?v=26','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

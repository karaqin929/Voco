...
const CACHE = 'voco-v17';
const FILES = ['/','/index.html?v=15','/style.css?v=15','/app.js?v=15','/manifest.json','/supabase-client.js?v=15','/parser.js?v=15','/icon.png','/bear-default.png','/bear-active.png'];

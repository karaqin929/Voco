...
const CACHE = 'voco-v16';
const FILES = ['/','/index.html?v=14','/style.css?v=14','/app.js?v=14','/manifest.json','/supabase-client.js?v=14','/parser.js?v=14','/icon.png','/bear-default.png','/bear-active.png'];

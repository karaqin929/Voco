...
const CACHE = 'voco-v24';
const FILES = ['/','/index.html?v=22','/style.css?v=22','/app.js?v=22','/manifest.json','/supabase-client.js?v=22','/parser.js?v=22','/icon.png','/bear-default.png','/bear-active.png'];

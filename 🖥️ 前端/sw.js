...
const CACHE = 'voco-v61';
const FILES = ['/','/index.html?v=51','/style.css?v=51','/app.js?v=51','/manifest.json','/supabase-client.js?v=51','/parser.js?v=51','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

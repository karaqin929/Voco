...
const CACHE = 'voco-v81';
const FILES = ['/','/index.html?v=71','/style.css?v=71','/app.js?v=71','/manifest.json','/supabase-client.js?v=71','/parser.js?v=71','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

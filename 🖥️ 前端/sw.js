...
const CACHE = 'voco-v83';
const FILES = ['/','/index.html?v=73','/style.css?v=73','/app.js?v=73','/manifest.json','/supabase-client.js?v=73','/parser.js?v=73','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

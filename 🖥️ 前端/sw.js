...
const CACHE = 'voco-v14';
const FILES = ['/','/index.html?v=12','/style.css?v=12','/app.js?v=12','/manifest.json','/supabase-client.js?v=12','/parser.js?v=12','/icon.png','/bear-default.png','/bear-active.png'];

...
const CACHE = 'voco-v15';
const FILES = ['/','/index.html?v=13','/style.css?v=13','/app.js?v=13','/manifest.json','/supabase-client.js?v=13','/parser.js?v=13','/icon.png','/bear-default.png','/bear-active.png'];

...
const CACHE = 'voco-v18';
const FILES = ['/','/index.html?v=16','/style.css?v=16','/app.js?v=16','/manifest.json','/supabase-client.js?v=16','/parser.js?v=16','/icon.png','/bear-default.png','/bear-active.png'];

...
const CACHE = 'voco-v97';
const FILES = ['/','/index.html?v=87','/style.css?v=87','/app.js?v=87','/manifest.json','/supabase-client.js?v=87','/parser.js?v=87','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

...
const CACHE = 'voco-v98';
const FILES = ['/','/index.html?v=88','/style.css?v=88','/app.js?v=88','/manifest.json','/supabase-client.js?v=88','/parser.js?v=88','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

...
const CACHE = 'voco-v80';
const FILES = ['/','/index.html?v=70','/style.css?v=70','/app.js?v=70','/manifest.json','/supabase-client.js?v=70','/parser.js?v=70','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];

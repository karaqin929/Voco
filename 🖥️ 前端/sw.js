...
const CACHE = 'voco-v93';
const FILES = ['/','/index.html?v=83','/style.css?v=83','/app.js?v=83','/manifest.json','/supabase-client.js?v=83','/parser.js?v=83','/icon.png','/bear-default.png','/bear-active.png','/bear-head-active.png','/bear-head-default.png'];
